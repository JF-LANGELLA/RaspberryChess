    ...
    function () {
        ...
        window.ChessBoard = window.ChessBoard || function (f, b) {
            ...
            function X(a) {
                a = a.split(".");
                return {
                    major: parseInt(a[0], 10), minor: parseInt(a[1], 10), patch: parseInt(a[2], 10)
                }
            }
            ...
            function I() {
                ...
                for (a = 0; a < b.length; a++) {
                    var c = "w" + b[a], d = "b" + b[a]; M[c] = c + "-" + n(); M[d] = d + "-" + n()
                }
            }
            ...
            function D(a, b, c) {
                ...
                d += 'alt="" class="' + h.piece + '" data-piece="' + a + '" style="width: ' + p + "px;height: " + p + "px;"; !0 === b && (d += "display:none;");
                return d + '" />'
            }
            ...
            function ha(a, e, c, d) {
                a = $("#" + s[a]);
                var C = a.offset(), f = $("#" + s[e]); e = f.offset();
                var k = n();
                $("body").append(D(c, !0, k));
                var g = $("#" + k);
            ...
            function ja(a, e, c) {
                function d() {
                    f++;
                    if (f === a.length && (G(), !0 === b.hasOwnProperty("onMoveEnd") && "function" === typeof b.onMoveEnd))
                        b.onMoveEnd(m(e), m(c))
                }
            ...
            function ba(a) {
                ...
                if (!0 === b.hasOwnProperty("onDrop") && "function" === typeof b.onDrop) {
                    ...
                    var d = m(g), c = b.onDrop(t, a, E, c, d, u);
            ...
            var fa = K("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR"), h = {
                ...
                board: "board-b72b1", chessboard: "chessboard-63f37",
                clearfix: "clearfix-7da63", highlight1: "highlight1-32417", highlight2: "highlight2-9c5d2",
                notation: "notation-322f9", numeric: "numeric-fc462", piece: "piece-417db",
                row: "row-5277c", sparePieces: "spare-pieces-7492f", sparePiecesBottom: "spare-pieces-bottom-ae20f", sparePiecesTop: "spare-pieces-top-4028b",
                square: "square-55d63", white: "white-1e1d7"
                ...
                if (0 !== arguments.length) {
                    for (var a = !0, b = {}, c = 0; c < arguments.length; c++)
                        if (!1 === arguments[c])
                            ...
                            var d;
                            d = arguments[c];
                            "string" !== typeof d ? d = !1 : (d = d.split("-"), d = 2 !== d.length ? !1 : !0 === l(d[0]) && !0 === l(d[1])); !0 !== d ? r(2826, "Invalid move passed to the move method.", arguments[c]) : (d = arguments[c].split("-"), b[d[0]] = d[1])
                        }
                    var c = g, c = m(c), f;
                    for (f in b)
            ...
            var W; if (W = !0 === function () {
                ...
                if (!0 !== b.hasOwnProperty("trashSpeed") || !0 !== w(b.trashSpeed))
                    b.trashSpeed = 100;
                !0 === b.hasOwnProperty("position") && ("start" === b.position ? g = m(fa) : !0 === Q(b.position) ? g = K(b.position) : !0 === F(b.position) ? g = m(b.position) : r(7263, "Invalid value passed to config.position.", b.position)); W = !0
            }
            W && (I(), ya(), xa());
            return q
        };
